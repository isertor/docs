...
<CardGroup cols="1">
  ...
  <Card title="How to set up POS Layouts" horizontal={false} href="configuring-atlas/pos-layout">
...
<Card title="How your customers can update their phone" horizontal={false} href="others/diners-phone-update">
  Diners can update their phone number on Atlas Online by logging in, recovering access, and verifying changes.
</Card>

## Integrations

<Card title="Hot to set up Revel integration" horizontal={false} href="configuring-atlas/revel-setup">
