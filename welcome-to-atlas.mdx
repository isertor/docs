...
<CardGroup cols="1">
  ...
  <Card title="Set up Atlas to earn more" icon="money-bill-wave" horizontal href="get-started/sell-more">
...
<Card title="How to use customers' data" icon="users" horizontal href="merchant-portal/customers-data">
...
<CardGroup cols="1">
  <Card title="How to create discounts" icon="megaphone" horizontal href="merchant-portal/add-discounts">
    Create and configure discounts / promotions in Atlas.
  </Card>
</CardGroup>
...
<CardGroup cols="1">
  ...
  <Card title="How to set up POS Layouts" horizontal href="configuring-atlas/pos-layout">
...
<CardGroup cols="1">
  <Card title="How to add operating hours and special hours" horizontal href="merchant-portal/operating-hours">
    This guide will walk you through how to add and edit your regulat restaurant operation hours, including special hours for public holidays or special occasions
  </Card>
</CardGroup>
...
<Card title="Connect an Atlas Printer to WiFi" horizontal href="others/printers">
  Step-by-step guide to connecting an Atlas printer to your WiFi network using manual pairing or QR pairing with WeChat.
</Card>
...
<Card title="Hot to set up Revel integration" horizontal href="configuring-atlas/revel-setup">
