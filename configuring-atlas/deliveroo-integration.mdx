...
- Enter its **Site location ID** (the 5-digit number shown next to your outlet name in Partner Hub).
- Under _Do you want to update your menus through your till?_ choose **Yes – I'll update my menu through my till (POS)**.
