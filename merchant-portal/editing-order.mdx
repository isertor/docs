...
<AccordionGroup>
  ...
  <Accordion title="Option 2: Edit order from Orders page" defaultOpen="true">
    ...
    1. In the top-right corner, tap "Update" to save your changes.
    2. A modal will pop up if any changes affect your driver booking (address, outlet, time, etc.). Tap "Save and update logistics booking".
  </Accordion>
</AccordionGroup>
