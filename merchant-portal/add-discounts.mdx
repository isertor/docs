---
title: "How to create discounts"
description: "This guide explains how to create and configure different types of discounts in Atlas, including setup steps and use cases for each."
---
